...
public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
{
    ...
    public ApiExceptionFilterAttribute(ILogger<ApiExceptionFilterAttribute> logger, IOptionsMonitor<ApiConfig> option)
    {
        _logger = logger;
        _apiConfig = option.CurrentValue;
    ...
    private void HandleValidationException(ExceptionContext context)
    {
        ...
        if (_apiConfig.mostrar_descripcion_badrequest.Equals(1))
        {
