...
{
    public static byte[] GenerarAutorizacionPersonaNatural(AutorizacionTransfExterna autorizacion, ApiConfig settings)
    {
        const string title =
            "SOLICITUD Y AUTORIZACIÓN DE DÉBITO POR TRANSFERENCIAS DE FONDOS A OTRAS INSTITUCIONES FINANCIERAS";
