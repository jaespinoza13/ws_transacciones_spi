...
public class DetalleOpi
{
    ...
    public string str_login_ingresa { get; set; } = string.Empty;
    public string str_login_revisa { get; set; } = string.Empty;
    public string str_login_aprueba { get; set; } = string.Empty;
    public string str_login_rechaza { get; set; } = string.Empty;
