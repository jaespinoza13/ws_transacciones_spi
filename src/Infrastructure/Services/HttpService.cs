        ...
        string strIdTransaccion)
    {
        try
        {
            ...
            else
            {
                ...
                _logs.SaveHttpErrorLogs( JsonSerializer.Deserialize<dynamic>( serializedData ),
                    MethodBase.GetCurrentMethod()!.Name, "HttpService", raw, strIdTransaccion );
            }
        ...
        catch (Exception ex)
        {
            ...
            _logs.SaveHttpErrorLogs( data, MethodBase.GetCurrentMethod()!.Name, _strClase, ex, strIdTransaccion );
