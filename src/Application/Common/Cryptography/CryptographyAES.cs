...
public static class CryptographyAes
{
    ...
    public static string Encrypt(string input, string passphrase, int? keySize = null)
    {
    ...
    public static string Decrypt(string input, string passphrase, int? keySize = null)
    {
        var key = CreateMd5Hash( passphrase );
