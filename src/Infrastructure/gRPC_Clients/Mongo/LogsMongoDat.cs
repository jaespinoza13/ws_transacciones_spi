...
public class LogsMongoDat : IMongoDat
{
    ...
    public LogsMongoDat(IOptionsMonitor<ApiSettings> settings, DALMongoClient objClienteMongo, ILogger<LogsMongoDat> logger)
    {
    ...
    public Task GuardarCabeceraMongo(dynamic request)
    {
        ...
        {
            _logger.LogError( e, "Error GuardarCabeceraMongo" );
        }
    ...
    public Task GuardarRespuestaMongo(dynamic request)
    {
        ...
        {
            _logger.LogError( e, "Error GuardarRespuestaMongo" );
        }

        return Task.CompletedTask;
    }

    public Task GuardarExcepcionesMongo(dynamic result, object excepcion)
    {
        ...
        try
        {
           ...
           _ = _objClienteMongo.insertar_documentoAsync( datosSolicitud );
        }
        catch (Exception e)
        {
            _logger.LogError( e,  "Error GuardarExcepcionesMongo" );
        }

        return Task.CompletedTask;
    }

    public Task GuardarExcepcionesDataBase(dynamic result, object excepcion)
    {
        var datosSolicitud = new DatosSolicitud();
        try
        {
        ...
        {
           _logger.LogError( e, "Error GuardarExcepcionesDataBase" );
        }

        return Task.CompletedTask;
    }

    public Task GuardaErroresHttp(object request, object excepcion, string strIdTransaccion)
    {
        var datosSolicitud = new DatosSolicitud();
        try
        {
        ...
        {
            _logger.LogError( e, "Error GuardaErroresHttp" );
        }
